...
public class EditContactsDialog extends JDialog implements View<Group> {
	...
	public EditContactsDialog(Frame owner) {
		super(owner);
		initComponents();
		init();
	}
	...
	public EditContactsDialog(Dialog owner) {
		super(owner);
		initComponents();
		init();
	}
	...
	private void searchContact() {
		SearchDialog dialog = new SearchDialog(this);
		dialog
				.setValidElements((Collection<SelectableItem>) ((Collection<? extends SelectableItem>) contactController
						.getElements()));
		//TODO current contact list as invalid selection Elements !!!  
		dialog.showDialog();
