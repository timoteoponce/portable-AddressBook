...
public class SearchDialog extends JDialog {
	...
	private void init() {
		elementList.setCellRenderer(new CustomListCellRenderer());
		getListModel().clear();
		//
	...
	private boolean isInvalid(SelectableItem item) {
		return invalidElements.isEmpty() || invalidElements.contains(item);
	}
		...
		// ======== dialogPane ========
		{
			...
			// ======== contentPanel ========
			{
				contentPanel.setLayout(new FormLayout(
						"32dlu, $lcgap, 147dlu, $lcgap, 59dlu",
